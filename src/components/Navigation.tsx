...
export default function Navigation() {
  ...
  return (
    <nav className={`${isHome ? 'fixed top-0 left-0 right-0 z-50 bg-transparent text-white' : 'bg-gray-800 text-white shadow-lg'}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="md:hidden">
            <button
              onClick={toggleMenu}
              className={`${isHome ? 'text-gray-200 hover:text-white hover:bg-white/10' : 'text-gray-300 hover:text-white hover:bg-gray-700'} inline-flex items-center justify-center p-2 rounded-md focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white`}
            >
      ...
      {isOpen && (
        <div className="md:hidden">
          <div className={`px-2 pt-2 pb-3 space-y-1 sm:px-3 ${isHome ? 'bg-black/70' : 'bg-gray-700'}`}>
