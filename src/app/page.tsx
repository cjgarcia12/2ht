      ...
      <section className="relative bg-gradient-to-br from-gray-800 via-gray-700 to-gray-600 text-white">
        ...
        <div className="relative container mx-auto px-4 py-24 text-center">
          ...
          <p className="text-xl md:text-2xl mb-8 max-w-2xl mx-auto text-gray-100">
            Experience the power of live music with our unique sound and energy
          </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-800 mb-8 leading-relaxed">
              2HTSounds brings together years of musical experience and passion to create unforgettable live performances. 
              Our diverse repertoire spans multiple genres, ensuring there&apos;s something for everyone at our shows.
            </p>
            <Link 
              href="/about" 
